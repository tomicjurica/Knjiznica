...
$sql="INSERT INTO  izdavaci(Naziv) VALUES(:izdavac)";
...
<head>
    ...
    <title>Knjižnica | Dodaj izdavača</title>
...
<input class="form-control" type="text" name="izdavac" autocomplete="off"  required />
</div>
