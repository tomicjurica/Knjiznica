...
$author=$_POST['author'];
$sql="update  autori set Naziv_Autora=:author where ID_Autor=:athrid";
...
<?php 
$athrid=intval($_GET['athrid']);
$sql = "SELECT * from  autori where ID_Autor =:athrid";
$query = $dbh -> prepare($sql);
$query->bindParam(':athrid',$athrid,PDO::PARAM_STR);
$query->execute();
...
{               ?>   
<input class="form-control" type="text" name="author" value="<?php echo htmlentities($result->Naziv_Autora);?>" required />
<?php }} ?>
</div>
